...
import cairosvg
from utils.pattern import core

FILL_COLOR = "rgb(194,217,255)"
STROKE_COLOR = "rgb(9,33,173)"
VERTEX_COLOR = "rgb(245,96,66)"
EDGE_COLOR = "rgb(50,179,101)"
            ...
            for idx in range(vertices.shape[0]):
                ...
                drawing.add(
                    drawing.text(str(idx), insert=vertices[idx] + shift, 
                                 fill=VERTEX_COLOR, font_size='25'))
            # name edges
